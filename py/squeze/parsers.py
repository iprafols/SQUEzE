...
MODE_PARSER.add_argument("--load-candidates",
                         action="store_true",
...
OPERATION_PARSER.add_argument(
    ...
    type=str,
    help=
    """[REQUIRED] Name of the json or fits file containing the model to be used
...
TEST_PARSER.add_argument("--check-statistics",
                         action="store_true",
