...
################################################################
# simple spectrum with three peaks and two power-law continuum #
################################################################
breakpoint = 6500
flux = 1e8 * wave**-2
flux[wave > breakpoint] = 1e8 * breakpoint * wave[wave > breakpoint]**-3
ivar = np.ones_like(wave)
peak_positions = [5000, 5500, 7000]
peak_amplitudes = [10, 7, 7]
peak_sigmas = [50, 50, 100]
...
# keep the spectrum
NOISELESS_TWO_POWER_LAW_SPEC = SimpleSpectrum(flux, ivar, wave, {})
MIN_SIGNIFICANCE_TWO_POWER_LAW = 2
PEAK_INDICES_TWO_POWER_LAW = [1000, 1500, 2999]
SIGNIFICANCES_TWO_POWER_LAW = [1132.98664036, 743.10860742, 1417.61561667]
BEST_FIT_TWO_POWER_LAW = [
    2.13091563e+00, 1.84409139e+00, 4.36540321e+00, 7.15400077e+03
]
