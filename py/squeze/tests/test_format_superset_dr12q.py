...
class TestFormatSupersetDr12Q(AbstractTest):
    ...
    def test_format_superset_dr12q_dataset1(self):
        ...
        out_file = "{}/results/formatted_boss_test1_plate7102.json".format(
            THIS_DIR)
        ...
        command = [
            ...
            "--qso-cat",
            f"{THIS_DIR}/data/cat_boss_test1.fits.gz",
            "--qso-cols",
            "RA",
            "DEC",
            "THING_ID",
            ...
            "Z_VI",
            "--out",
            out_file.split("_plate")[0],
            "--input-folder",
            f"{THIS_DIR}/data/",
            "--plate-list",
            f"{THIS_DIR}/data/platelist_7102.fits",
            "--sky-mask",
            f"{THIS_DIR}/data/dr12-sky-mask.txt",
        ]
    ...
    def test_format_superset_dr12q_dataset2(self):
        """ Run format_superset_dr12q.py """
        out_file = "{}/results/formatted_boss_test2_plate7102.json".format(
            THIS_DIR)
        ...
        command = [
            ...
            f"{SQUEZE_BIN}/format_superset_dr12q.py",
            "--qso-cat",
            f"{THIS_DIR}/data/cat_boss_test2.fits.gz",
            "--qso-cols",
            "RA",
            "DEC",
            "THING_ID",
